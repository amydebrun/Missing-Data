...
```{r fig.width=5, fig.height=3, echo=FALSE, fig.cap="Missing not at Random conditional on L, X_1 and X_2"}
MNAR_dag1
```

```{r fig.width=5, fig.height=3, echo=FALSE, fig.cap="Missing at Random conditional on L, X_2"}
MNAR_dag2
```
