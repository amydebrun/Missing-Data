...
MCAR test*) [@little_statistical_2002]. It is a likelihood-ratio test that groups missing data
...
In this report, we have also tested how changing estimand would affect our conclusion for both data sets.
...
At last, we performed sensitivity analysis , and present the results by forest plots and heat maps.
...
```{r fig.width=5, fig.height=3,fig.cap="Sensitive analysis for VITAL data set"}
print(SA_vital_plot)
```
