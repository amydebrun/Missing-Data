...
effects of acupuncture therapy on chronic headache in primary care . Vickers released the dataset from the study in
...
imputed pk5 values, and the pooled regression estimates are filtered for
the intercept term, representing the average outcome in the control
group.
