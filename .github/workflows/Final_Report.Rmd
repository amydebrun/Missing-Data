...
```{r fig.width=5, fig.height=4, fig.pos='H', fig.cap="Sensitive analysis for Acupuncture data set"}
print(SA_acu_all)
```

```{r fig.width=5, fig.height=4,fig.pos='H',   fig.cap="Sensitive analysis for VITAL data set"}
...
adjustment sensitivity analysis. In figure 23 which shows the acupuncture
...
```{r fig.width=4, fig.height=2,fig.pos='H',   fig.cap="original acu estimand"}
print(cat_heatmap_acu_plot)
```

```{r fig.width=4, fig.height=2,fig.pos='H',   fig.cap="changed acu estimand"}
print(cont_heatmap_acu_plot)
```

```{r fig.width=4, fig.height=2,fig.pos='H',   fig.cap="original fishoil estimand"}
print(cat_heatmap_fishoil_plot)
```

```{r fig.width=4, fig.height=2,fig.pos='H',   fig.cap="changed fishoil estimand"}
print(cont_heatmap_fishoil_plot)
```

```{r fig.width=4, fig.height=2, fig.pos='H',  fig.cap="original vitd estimand"}
print(cat_heatmap_vitd_plot)
```

```{r fig.width=4, fig.height=2, fig.pos='H',  fig.cap="changed vitd estimand"}
