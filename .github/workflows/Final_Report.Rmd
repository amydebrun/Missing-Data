...
```{r fig.width=5, fig.height=3, echo=FALSE, fig.cap="MCAR DAG"}
MCAR_dag
```
...
```{r fig.width=5, fig.height=4, echo=FALSE, fig.cap="MAR DAG"}
MAR_dag1
MAR_dag2
```
...
```{r fig.width=5, fig.height=4, echo=FALSE, fig.cap="MNAR DAG"}
MNAR_dag1
MNAR_dag2
```
