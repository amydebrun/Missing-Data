...
The shift can be broken down in to[@noauthor_httpsstefvanbuurennamefimdsec-nonignorablehtmlsecnonignorable_nodate]:
...
- $\delta_\mathrm{MNAR}$: mean difference caused by an additional non-ignorable part of the imputation model. 
...
adjustment sensitivity analysis. In figure 27 which shows the acupuncture
