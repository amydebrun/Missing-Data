...
bibliography: Missing_Data_Reference_0625.bib
biblio-style: unsrt
...
observed data. As described by [@little_statistical_2002-1], it's important to
...
```{r fig.width=5, fig.height=3, fig.cap="Proportion of missing data in outcome variables $pk2$ and $pk5$. This follows a monotonic missing data pattern."}
...
```{r fig.width=5, fig.height=3, fig.cap="Higher percentage of missing data (dark green) in control group"}
...
```{r fig.width=5, fig.height=4, fig.align='center',fig.cap="Percentage of missing data across baseline and 4 follow-up time points. Non-monotonic pattern appears similar in 4 randomised groups."}
...
To address this, [@white_multiple_2011-1] proposed a simple and
...
A widely cited rule of thumb proposed by [@white_multiple_2011-1]
