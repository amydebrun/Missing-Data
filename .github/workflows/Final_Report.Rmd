...
Sharing (UNOS) database (Baker et al 2025) [@baker_systematic_2025]. Forty-one studies used
...
when varying the $\delta$ adjustments under MNAR. We are comparing both the original estimand (heatmap on the left handside) and
the changed estimand (heatmaps on the right handside) The aim here is to
