...
In [@powney_review_2014] reviewed 100 longitudinal clinical trials
...
and 12 months. Which are the outcomes of interest in this project.
...
*Figure 15* shows the missing data pattern from baseline to the final follow up time point in
the treatment group and control group. Pattern (1,1,1) is shown at the top row which represents the participants that had observed 
throughout the three time points (shown as light green). 136 participants followed this pattern (56.5% of the participants). 
(1,1,0) is in the second row. This represents the participants that had observed headache severity scores at baseline and
at 3 months, but was not observed at the final time point (light green at baseline and 3 months, but dark green at 
final time point). Only 17 followed this pattern (7.1% of the participants). 
...
which data is observed at all time-points (shown in light green blocks in the first
row of each group).
