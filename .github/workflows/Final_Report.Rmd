...
included complete case analysis, LOCF, and the mean observation method. Each of these approaches was
...
the outcome is MAR, conditional on the observed
...
LOCF is a simple imputation method
...
assuming data are MCAR, since it ignores
...
data sets analyzed here. In both the Acupuncture and VITAL trials, pain
...
multiple imputation [@carpenter_multiple_2023]. In cases with a monotonic missing data pattern,
...
Once multiple imputed datasets are generated, Rubin’s rules [@noauthor_rubin1987_1987] are used to
...
assume MAR, then each of these conditional
...
more flexible approaches like Joint Modeling or FCS are required to properly handle the complex,
...
To address this, [@white_multiple_2011-1] proposed a simple and conservative
...
information is moderate. As discussed in [@noauthor_rubin1987_1987], the argument for
...
-   [@royston_royston2004multiple_2004] suggested that to constrain the coefficient of
...
-   [@graham_how_2007] argued that to achieve statistical power within 1% of
    the theoretical maximum, researchers should use at least K=20.
-   [@bodner_bodner2008what_2008] examined how the number of imputations relates to the
