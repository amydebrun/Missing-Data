...
To outlines the application of the $\delta$-adjustment
...
imputed pk5 values, and after applying $pk5_i = \beta_0 + \beta_1pk1_i + \varepsilon_i$ to each dataset (as there is no group term), we estimate the headhache severity score
