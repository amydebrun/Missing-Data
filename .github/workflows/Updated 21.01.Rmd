...
```{r mytable, echo=FALSE, fig.height=6, fig.width=14}
## Ploting
...
```
Figure 1. Proportions of Missing Data over time in longitudinal trial (MacFarlane et al. 2020)
...
Figure 2. Proportions of missing data(dark green) overtime within treatment groups. Proportions are similar within each group.
 
```{r mytable3, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=14}
...
Figure 3. The missing data patterns grouped by fish oil intake. Differences in patterns can be observed.
