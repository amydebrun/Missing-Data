...
- Missing Completely at Random (MCAR) - Missing data is unrelated to making inference about the treatment effect. This can occur due to illness/death or a treatment malfunction - nothing to do with the results of the research. This is the best case scenario as the results remain unbiased and the intervention effect unchanged.  
- Missing at Random - Missing data is systematically related to the observed variables but not the unobserved variables. For example, males may be unwilling to answer survey questions about mental health due to gender stereotypes, but not due to their mental health status. [^5]
- Missing Not at Random - Missing data is related to the unobserved data itself. People with a gambling addiction may avoid answering survey questions about their spending habits, leaving data missing not at random. This is the most difficult to account for. We must investigate the data distributions of patients with missing data and compare to full data distributions. 
