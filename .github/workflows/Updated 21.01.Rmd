...
| Trial                  | Vitamin D & omega trial[^3]  | Acupuncture Trial[^2] |
| -----------------------| -----------------------------| ----------------------------|
...
```{r mytable4, echo=FALSE, warning=FALSE, fig.height=8, fig.width=14}
pct_format = scales::label_percent(accuracy = .1)
...
Figure 4. Proportions of Missing data over time in Acupuncture trial 
...
```{r mytable6, echo=FALSE, warning=FALSE, fig.height=8, fig.width=14}
