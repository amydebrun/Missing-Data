...
```{r morefigs, out.width='80%', echo=FALSE,  warning=FALSE, fig.cap='Tile graph of the frequency of missing data within these variables', fig.height=5}
library(readr)
library(ggplot2)
...
```{r morefigs2, out.width='80%', echo=FALSE,  warning=FALSE, fig.cap='Bar Plot of missing data in pk2 & pk5', fig.height=5}
