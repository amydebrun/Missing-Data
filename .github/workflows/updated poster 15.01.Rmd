...
data_miss %>%
  ...
  scale_fill_manual(name = "Data Observed\nIndicator (R)", values=c("mediumpurple1", "slateblue3")) +
...
```{r mytable2, echo=FALSE, warning=FALSE, fig.cap='', fig.height=9, fig.width=15}
...
## Third plot
  ...
  scale_colour_manual(values=c("mediumpurple1", "slateblue3"))
  theme(text = element_text(size = 18), legend.postition="none")
...
acupuncture_miss <- acupuncture %>%
  ...
  mutate(miss_pattern_label = factor(miss_pattern_label, levels = unique(miss_pattern_label)))
```
```{r mytable4, echo=FALSE, warning=FALSE, fig.cap='', fig.height=9, fig.width=14}
# 1st plot
...
acupuncture_miss %>%
  ...
  stat_identity(geom = "text", colour = "white", size = 3.5,
                aes(label =perc_pat), 
                position = position_stack(vjust=0.5)) +
  scale_fill_manual(values=c("lightsteelblue","royalblue")) + 
  scale_x_discrete(name = "Time") +
  scale_y_continuous(name = "Count (patients)") +
  theme(text = element_text(size = 18),
...
```{r mytable5, echo=FALSE, warning=FALSE, fig.cap='', fig.height=9, fig.width=14}
# 2nd plot
...
acupuncture_miss %>%
  ...
  stat_identity(geom = "text", colour = "white", size = 3.5,
                aes(label =perc_pat), 
                position = position_stack(vjust=0.5)) +
  scale_fill_manual(name = "Data Observed\nIndicator (R)", values=c("lightsteelblue","royalblue")) + 
  scale_x_discrete(name = "Time") +
  scale_y_continuous(name = "Count (patients)") +
  theme(text = element_text(size = 18),
        axis.text.x = element_text(angle = 90, vjust = 0.5),legend.position = "none")
